...
# Permitir Specific HTML elements like allowed_elements set to table_allowed_elements

The allowed elements include examples such as `<table>`, `<tr>`, `<td>`, `<th>`, `<thead>`, `<tbody>`, and `<tfoot>`.
